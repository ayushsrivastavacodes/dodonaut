...
export default function ConnectWalletPage() {
  ...
  return (
    <AuthShell
      ...
      asideBody="We watch your address for incoming USDG and USDC settlements. The agent's payment goes directly to you on-chain — Dodonaut is the paywall, not the custodian."
      asideMetric={{
        value: "<400ms",
